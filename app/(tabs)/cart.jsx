      ...
      const unsubscribe = onValue(dataRef, (snapshot) => {
        ...
        if (fetchedData) {
          const formattedData = Object.keys(fetchedData).map((key) => ({
            id: fetchedData[key].productID ? fetchedData[key].productID : key,  // Ensure uniqueness
            name: fetchedData[key].productName || "Unknown",
            price: fetchedData[key].productTotal || "0",
            qty: fetchedData[key].productQty || "0",
          }));
    
          setProductList(formattedData);  // Directly update list instead of filtering
        }
      });
